...
namespace Damarev\FilamentLocationField\Forms\Components;
...
class LocationInput extends Field
{
    protected string $view = 'filament-location-field::forms.components.location-input';
    ...
    {
        return $this->evaluate($this->draggable) ?? config('filament-location-field.default_draggable');
    }
    ...
    {
        return $this->evaluate($this->clickable) ?? config('filament-location-field.default_clickable');
    }
    ...
    {
        return $this->evaluate($this->myLocationButtonLabel) ?? config('filament-location-field.my_location_button', 'My location');
    }
